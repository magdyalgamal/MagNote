    ...
    Private Sub Download_Update_Btn_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Download_Update_Btn.Click
        Try
            ...
            Using WClient As New WebClient()
                ...
                WClient.DownloadFileAsync(New Uri("ftp://2728786@p25-preview.awardspace.net/infosysme.com/" & File_Name_TxtBx.Text), Update_Download_File_Path_TxtBx.Text & "\" & File_Name_TxtBx.Text)
            End Using
