...
Public Class IconHelper : Implements IDisposable
    ...
    Private Interface IImageList
        ...
        <PreserveSig()> Function GetDragImage(ByRef ppt As System.Drawing.Point, ByRef pptHotspot As System.Drawing.Point, ByRef riid As Guid, ByRef ppv As IntPtr) As Integer
    ...
    Public Shared Function GetIconFrom(ByVal PathName As String, ByVal IcoSize As IconSize, ByVal UseFileAttributes As Boolean) As Icon
        ...
        If iml IsNot Nothing Then
            ...
            DestroyIcon(hIcon)
            Dim x = ico.ToBitmap.PixelFormat
